                ...
                <div class="list col-9 mx-auto h-100 ">
                    <div class="process border-bottom ">
                        ...
                        <div class="progress-rate d-flex mb-5 ">
                            ...
                            <div class="order ">
                                <div class="number01 ml-4"><span >2</span> 
                                </div>
                    ...
                    <div class="next-or-back d-flex justify-content-between mx-5 my-5">
                        <div class="back d-flex">
                            <div class="icon"><i class="bi bi-arrow-left"></i></div> 返回購物</div>
                        <div class="next">  <button class="btn btn-primary px-5 py-2"  onclick="location.href='/digital-cube -bootstrap/shop 02.html'" type="submit">下一步</button></div>
                    </div>
