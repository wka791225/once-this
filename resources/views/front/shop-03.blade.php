                ...
                <div class="list col-9 mx-auto h-100 ">
                        ...
                        <form >
                            <div class="form-row ">
                              <div class="form-group col-md-12">
                                ...
                                <input type="email" class="form-control" id="inputEmail4"placeholder="王小明" >
                              </div>
                              <div class="form-group col-md-12">
                    ...
                    <div class="next-or-back">
                        <div class="back d-flex pt-4 pb-5">
                            <div class="icon"><button type="button" onclick="location.href='/digital-cube -bootstrap/shop 03.html'" class="btn btn-outline-primary px-5 py-2">上一步</button></div>
                        <div class="next ml-auto">  <button type="button" onclick="location.href='/digital-cube -bootstrap/shop 04.html'" class="btn  btn-primary px-5 py-2" type="submit">前往付款</button></div>
                    </div>
