                ...
                <div class="list col-9   mx-auto h-100">
                    <div class="process border-bottom ">
                        ...
                        <div class="progress-rate d-flex mb-5 ">
                            ...
                            <div class="order ">
                                <div class="number01 ml-2"><span>3</span>
                                </div>
                                <div class="datamaen  text-dark">填寫資料</div>
                            </div>
                            
                            <div class="g-container mt-3 mr-2">
                                <div class="g-progress02"></div>
                            </div>
                            <div class="order ">
                    ...
                    <div class="items ">
                        <div class="text">
                            <h2>付款方式</h2>
                            <div class="price-funtion">

                                <div class="credit-card d-flex border-bottom my-5">
                                    <input class="mt-2 mx-2" type="radio" name="active" id="active">
                                    <label class="item-name mb-4"for="active">信用卡支付</label>
                                </div>      
                                <div class="credit-card d-flex border-bottom my-5">
                                    <input class="mt-2 mx-2" type="radio" name="active" id="active01">
                                    
                                    <label class="item-name  mb-4" for="active01">網路 ATM</label>
                                </div>      
                                <div class="credit-card d-flex border-bottom my-5">
                                    <input  class="mt-2 mx-2" type="radio" name="active" id="active02">
                                    <label class="item-name  mb-4" for="active02">超商代碼</label>
                                </div>
                                
                            </div>
                        </div>
                        <div class="transport-funtion">
                            <div class="text">
                                <h2>運送方式</h2>
                            </div>
                            <div class="transport">
                                <div class="credit-card d-flex border-bottom my-4">
                                    <input class="mt-2 mx-2" type="radio" name="trans" id="trans">
                                    <label class="item-name mb-4"for="trans">信用卡支付</label>
                                </div>      
                                <div class="credit-card d-flex border-bottom my-4">
                                    <input class="mt-2 mx-2" type="radio" name="trans" id="trans01">
                                    <label class="item-name mb-4" for="trans01">網路 ATM</label>
                            </div>
                    ...
                    <div class="next-or-back">
                        <div class="back d-flex pt-4 pb-5">
                            <div class="icon"><button type="button" onclick="location.href='/digital-cube -bootstrap/shop.html'" class="btn btn-outline-primary px-5 py-2">上一步</button></div>
                        <div class="next ml-auto">  <button type="button" onclick="location.href='/digital-cube -bootstrap/shop 03.html'" class="btn  btn-primary px-5 py-2" type="submit">下一步</button></div>
                    </div>
