...
<body>
    ...
    <section id="text  ">
        <div class="container mb-5 col-12 col-lg-12 col-md-6 col-sm-6 ">
            ...
            <div class="mean-text mx-auto  col-7 "><p class="text-center mb-4">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy.Gastropub indxgo juice poutine, ramps microdosing banh mi pug.</p>
            </div>
                        ...
                        <p class="card-text  text-center">Blue bottle crucifix vinyl post-ironic four dollar toast vegan
                            ...
                            <div class="d-flex align-items-center justify-content-center ">
                                ...
                                <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" class=" one-bule arrow ml-1" viewBox="0 0 24 24">
                ...
                <div class="card border-0 text-center">
                    ...
                    <div class="card-body p-0">
                        ...
                        <p class="card-text pb-3 text-center">Blue bottle crucifix vinyl post-ironic four dollar toast vegan
                            taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug VHS try-hard.</p></div>
                            <div class="d-flex align-items-center justify-content-center ">
                                <div class="next-more one-bule  ">Learn More </div>
                                <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2" class=" one-bule arrow ml-1" viewBox="0 0 24 24">
        ...
        <div class="container  mx-auto py-5 ">
            <div class="row my-5 pt-5">
                ...
                <div class="tito d-lg-flex ml-2 ">
                    ...
                    <div class="  thing-text col-12  col-lg-7 pb-4 pl-0">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical
            ...
            <div class=" all-pic d-flex my-5">
                ...
                <div class="pic-left col-6 p-0">
                    ...
                    <div class="pic-Ldon d-flex ">
                        ...
                        <div class="503 col-6 p-2  "><img class="small-pic" src="./img/503x303.png" alt=""></div>
                    </div>
                </div>
            </div>
                ...
                <table class="table  mx-auto col-9  ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="arrow ml-2"
                            viewBox="0 0 24 24">
                            <path d="M5 12h14M12 5l7 7-7 7"></path>
                        </svg></td>
                            <td></td>
                ...
                <div class="bgc ">
                    <div class="card  border-0 bg-gray-100   ">
                        ...
                        <div class="card-body pl-0 mt-1 ">
                            ...
                            <p class="card-text " style="font-size: 16px;">Fingerstache flexitarian street art 8-bit waistcoat. Distillery hexagon
                    ...
                    <div class="pic-text col-sm-9  mt-5  text-center text-sm-left  border-bottom">
                        ...
                        <p>Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo
                            ...
                            <div class="next-more one-bule pb-3">Learn More
                                <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                    stroke-linejoin="round" stroke-width="2" class="arrow ml-2" viewBox="0 0 24 24">
                                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                                </svg>
                            </div>
                    </div>
                            ...
                            <div class="text col-12 col-lg-11 mt-3 ">
                                ...
                                <div class="pay d-flex  justify-content-between ">
                                    ...
                                    <div class="user-button d-flex ">
                                        ...
                                        <div class="heart ">
                                            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class=""
                                            viewBox="0 0 24 24">
                                            <path
    ...
    <section id="map ">
        <div class="map-messenger position-relative ">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d466244.0404081637!2d120.8462863!3d24.0827952!3m2!1i1024!2i768!4f13.1!5e0!3m2!1szh-TW!2stw!4v1646891599751!5m2!1szh-TW!2stw" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            <div class="container    ">
                ...
                <form class=" message position-absolute">
                    ...
                    <div class="small-text "><p>Chicharrones blog helvetica normcore iceland tousled brook viral artisan.</p></div>
                  </form>
            </div>
